...
import 'package:resman_mobile_customer/src/blocs/authenticationBloc/event.dart';
import 'package:resman_mobile_customer/src/blocs/changePasswordBloc/bloc.dart';
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              GradientButton(
                                ...
                                callback: () {
                                  if (_validateInputs()) if (!isChanging)
                                    _changePasswordBloc
                                        .dispatch(ChangePasswordEvent(
